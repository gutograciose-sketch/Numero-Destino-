...
import { Sparkles, Calendar, ArrowRight, Loader2, RefreshCw, Star, ShieldCheck } from 'lucide-react';
          ...
          {step === QuizStep.WELCOME && (
            ...
            >
              <HeroSection
                ...
                subtitle="O universo não joga dados. Ele calcula. Descubra o código matemático que rege o seu destino e a missão secreta da sua alma."
                primaryButtonText="Iniciar Alinhamento"
                primaryButtonOnClick={handleStart}
                imageUrl={mentorImg}
              />
            </motion.div>
          )}
